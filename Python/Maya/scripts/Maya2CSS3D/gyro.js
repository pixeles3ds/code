...
(function (root, factory) {
	...
	gyro.measurements = measurements;
	...
	gyro.inverseQuaternion = inverseQuaternion;
	/**
	 * @private
	 */
	...
	gyro.quaternionToEuler = quaternionToEuler;


	function getAlphaCalib(b,g,a){
		...
		res.beta = calibEuler.beta;
		res.gamma = calibEuler.gamma;
		res.alpha = calibEuler.alpha;

		return res;
	}

	gyro.getAlphaCalib = getAlphaCalib;
